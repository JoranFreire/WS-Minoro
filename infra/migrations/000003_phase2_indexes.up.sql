...
CREATE INDEX IF NOT EXISTS idx_link_destinations_expired_cooldown
...
CREATE INDEX IF NOT EXISTS idx_link_destinations_active_link
...
CREATE INDEX IF NOT EXISTS idx_link_destinations_risk_score
